...
def test_date_range_status_predicates_contain_two_placeholders():
    assert DATE_RANGE_STATUS_PREDICATE.count("?") == 2
    assert DATE_RANGE_STATUS_PREDICATE_ALIASED.count("?") == 2
