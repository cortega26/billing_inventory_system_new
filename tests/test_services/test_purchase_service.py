        ...
        "items": [
            {
                ...
                "quantity": 10,
                "price": 900  # Purchase price
            }
        ]
    }

class TestPurchaseService:
    def test_create_purchase(self, purchase_service, sample_purchase_data, inventory_service, sample_product):
        # Create purchase
    ...
    def test_void_purchase(self, purchase_service, sample_purchase_data, inventory_service, sample_product):
        # Create purchase
        purchase_id = purchase_service.create_purchase(**sample_purchase_data)
    ...
    def test_update_purchase_reference(self, purchase_service, sample_purchase_data):
        purchase_id = purchase_service.create_purchase(**sample_purchase_data)
        
        # Update reference number
        reference = "PO123456"
        purchase_service.update_purchase_reference(purchase_id, reference)
        
        # Verify update
        purchase = purchase_service.get_purchase(purchase_id)
        assert purchase.reference_id == reference
