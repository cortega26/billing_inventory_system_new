...
- [ ] Midpoint gap review (fresh sub-agent on spec.md vs implementation) after plan 3
...
- [ ] Orchestrator verifies the pre-existing-failure claim on base b0dd06a
- [ ] Orchestrator re-runs done criteria + reads diff
- [ ] Merge to main, push, clean worktree, archive plan 015, mark DONE
